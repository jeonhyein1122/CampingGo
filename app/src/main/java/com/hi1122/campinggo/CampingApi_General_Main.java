...
public class CampingApi_General_Main extends AppCompatActivity {

    ArrayList<CampingApi_General_RecyclerItem> items=new ArrayList<>();
    RecyclerView recyclerView;
    CampingApi_General_Adapter adapter;
    String tagName;
    String img;

    CampingApi_General_RecyclerItem item= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camping_api_general_main);


        recyclerView = findViewById(R.id.recyclercampingapige);
        adapter = new CampingApi_General_Adapter(this, items);
                        ...
                        switch (eventType) {
                            ...
                            case XmlPullParser.START_TAG:
                                ...
                                if (tagName.equals("item")) {
                                    item = new CampingApi_General_RecyclerItem();
...
//                                    String text = xpp.getText();
                            ...
                            case XmlPullParser.END_TAG:
                                ...
                                if (tagName2.equals("item")) {
                                    if (item.campingimg!=null && item.induty.equals("일반야영장")){
                                        items.add(item);
                                    }
