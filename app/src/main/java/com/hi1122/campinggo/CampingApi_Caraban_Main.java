...
public class CampingApi_Caraban_Main extends AppCompatActivity {

    ArrayList<CampingApi_Caraban_RecyclerItem> items=new ArrayList<>();
    RecyclerView recyclerView;
    CampingApi_Caraban_Adapter adapter;
    String tagName;
    String img;

    CampingApi_Caraban_RecyclerItem item= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camping_api_caraban_main);

        recyclerView = findViewById(R.id.recyclercampingapica);
        adapter = new CampingApi_Caraban_Adapter(this, items);
                        ...
                        switch (eventType) {
                            ...
                            case XmlPullParser.START_TAG:
                                ...
                                if (tagName.equals("item")) {
                                    item = new CampingApi_Caraban_RecyclerItem();
...
//                                    String text = xpp.getText();
                            ...
                            case XmlPullParser.END_TAG:
                                ...
                                if (tagName2.equals("item")) {
                                    if (item.campingimg!=null && item.induty.equals("카라반")){
                                        items.add(item);
                                    }
