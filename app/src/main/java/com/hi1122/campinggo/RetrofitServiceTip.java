...
public interface RetrofitServiceTip {
    ...
    @Multipart
    @POST("/Campinggotip/insertDB.php")
    Call<String> postDataToServer(@PartMap Map<String, String> dataPart,
                                  @Part MultipartBody.Part filePart);


    //서버에서 데이터를 json으로 파싱하여 가져오는 추상메소드
    @GET("/Campinggotip/loadDB.php")
    Call<ArrayList<Home_Second_RecyclerItem>> loadDataFromServer();
