...
public class CampingApi_Glamping_Main extends AppCompatActivity {

    ArrayList<CampingApi_Glamping_RecyclerItem> items=new ArrayList<>();
    RecyclerView recyclerView;
    CampingApi_Glamping_Adapter adapter;
    String tagName;
    String img;

    CampingApi_Glamping_RecyclerItem item= null;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.camping_api_glamping_main);


        recyclerView = findViewById(R.id.recyclercampingapigl);
        adapter = new CampingApi_Glamping_Adapter(this, items);
                        ...
                        switch (eventType) {
                            ...
                            case XmlPullParser.START_TAG:
                                ...
                                if (tagName.equals("item")) {
                                    item = new CampingApi_Glamping_RecyclerItem();
...
//                                    String text = xpp.getText();
                            ...
                            case XmlPullParser.END_TAG:
                                ...
                                if (tagName2.equals("item")) {
                                    if (item.campingimg!=null && item.induty.equals("글램핑")){
                                        items.add(item);
                                    }
